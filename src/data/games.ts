...
export const GAMES: GameInfo[] = [
  {
    ...
    description: 'Utility bills for Electricity, Water, Dialog Mobile, and SLT Fibre float in AR around you. Use your fingertip to pinch, drag, and swipe them directly into the Sampath Vishwa QuickPay zone to settle in seconds.',
  ...
  },
  {
    ...
    description: 'Designed for high-speed modern lifestyles. When your hands are full, approve or decline critical transactions, scheduled transfers, and credit card settlements simply by tilting your head left or right.',
  ...
  },
  {
    ...
    description: 'Experience the power of compounding interest and e-Fixed Deposits. Golden currency coins and high-yield interest rate badges shower down in AR. Cup your hands together to funnel wealth directly into the Vishwa Digital Vault.',
  ...
  },
  {
    ...
    description: 'Become a human firewall for your digital banking. Your body is scanned into a futuristic biometric defense grid. Raise and cross your arms to project an energy shield that deflects phishing and malware while welcoming verified OTP tokens.',
